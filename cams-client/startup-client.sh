...
REACT_APP_RESOURCE_URL=$RESOURCE_PROTOCOL://$RESOURCE_IP:$RESOURCE_PORT REACT_APP_HUB_HOST=$HUB_IP REACT_APP_HUB_OUT_PORT=$HUB_OUT_PORT PORT=$FRONT_PORT FAST_REFRESH=false npm run start