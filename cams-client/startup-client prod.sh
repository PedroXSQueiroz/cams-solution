...
REACT_APP_RESOURCE_URL=$RESOURCE_PROTOCOL://$RESOURCE_IP:$RESOURCE_PORT REACT_APP_HUB_HOST=$HUB_IP REACT_APP_HUB_OUT_PORT=$HUB_OUT_PORT PORT=$FRONT_PORT lite-server -c /client/config.json